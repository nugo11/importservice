        ...
        <div className="grid lg:grid-cols-2 gap-16 items-start">
          ...
          >
            ...
            <h1 className="text-4xl md:text-6xl font-black tracking-tighter text-brand-dark mb-8 leading-none">
              {t('products.roof.title')}
            </h1>
            <div className="text-brand-gray mb-12 font-medium leading-relaxed text-base">
              <p className="mb-4">
                ჩვენი სახურავის სენდვიჩ პანელები წარმოადგენს თანამედროვე მშენებლობის სტანდარტს. ისინი შექმნილია იმისთვის, რომ გაუძლოს ექსტრემალურ ამინდს, უზრუნველყოს მაქსიმალური თერმოიზოლაცია და აბსოლუტური ჰერმეტულობა.
              </p>
              <p>
                პანელები შედგება ორი ფენის მაღალი ხარისხის გალვანიზებული ლითონისა და მათ შორის მოთავსებული საიზოლაციო ფენისგან (PIR, PUR ან Rockwool). ეს კონსტრუქცია უზრუნველყოფს შენობის ენერგოეფექტურობას და ხანგრძლივ ექსპლუატაციას.
              </p>
            </div>
