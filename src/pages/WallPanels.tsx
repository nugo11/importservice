...
const WallPanels = () => {
    ...
    "@graph": [
      {
        ...
        "itemListElement": [
          ...
          { "@type": "ListItem", "position": 3, "name": "კედლის პანელები", "item": "https://importservisi.ge/products/wall" }
        ]
      },
      {
        "@type": "Product",
        "name": "კედლის სენდვიჩ პანელები (დამალული და სტანდარტული სამაგრით)",
        "image": "https://importservisi.ge/images/wall-panels.jpg",
        "description": "თერმოიზოლირებული კედლის სენდვიჩ პანელები ფასადებისთვის, შიდა ტიხრებისა და სამაცივრე ოთახებისთვის (PIR, PUR, Rockwool). სისქე 40მმ-დან 150მმ-მდე. ფასი დამოკიდებულია მოცულობასა და სპეციფიკაციაზე.",
  ...
  usePageMeta({ 
    ...
    description: t('products.wall.desc'),
    canonicalPath: '/products/wall',
    image: '/images/wall-panels.jpg',
    schema: wallProductSchema
  });
